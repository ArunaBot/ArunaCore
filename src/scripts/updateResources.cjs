...
const loaderDest = path.resolve(__dirname, '..', '..', 'build', 'nodejs', 'main', 'loader.js');
...
const registerLoaderDest = path.resolve(__dirname, '..', '..', 'build', 'nodejs', 'main', 'registerLoader.js');
